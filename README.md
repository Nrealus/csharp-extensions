...
This unique reference to the obejct is accessed via the "RefWrapper" wrapper object. The "RefWrapper" also offers a workaround to achieve something similar to a C++ "Destructor".
